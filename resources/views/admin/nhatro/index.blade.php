...
@section('content')
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($nhatros as $nhatro)
                                            <tr>
                                                ...
                                                <td>{{ $nhatro->status }}</td>
                                                <td>
                                                    <button class="mr-2 ml-2 detailsBtn" href="#" data-toggle="modal" data-target=".exampleModal_detail" data-class-id="{{ $nhatro->id }}"><i class="fas fa-eye"></i></button>
    ...
    <!-- modal  -->
    <!-- ============================================================== -->
    <div class="modal fade exampleModal_detail" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
